			...
			<div class="col-md-4">
				<div style="box-shadow:0 2px 5px 0 rgba(0,0,0,0.16),0 2px 10px 0 rgba(0,0,0,0.12);background-color: white;padding: 20px;height: 100%;">
					...
					<div class="page-header">
						...
						<input type="text" name="user" value="<?php echo $_POST['convo']; ?>" required> <button class="btn btn-danger btn-xs"><a href="list.php" style="text-decoration: none;color: white;">Contacts</a></button>
					</div>
										...
										if ($display->num_rows) {
											while ($row = $display->fetch_assoc()) {
												if ($selected == $row['sender']) {
													...
													echo "<img src='user.png' style='width:30px;width:50px;box-shadow:0 2px 5px 0 rgba(0,0,0,0.16),0 2px 10px 0 rgba(0,0,0,0.12);' class='img-circle' ><span>&nbsp;&nbsp;&nbsp;You</span>";
													echo "</div></div><br><br>";
												}else{
													echo "<div class='row'>";
